    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<ActionResult<TokenResponseDto>> RefreshToken([FromBody] RefreshTokenDto refreshTokenDto)
        {
            try
            {
                ...
                {
                    return Unauthorized(new { message = "Refresh token expire ou revoque" });
                }
        ...
        {
            // Support des anciens mots de passe SHA256 et des nouveaux BCrypt
            ...
            {
                // Migration: ancien format SHA256
